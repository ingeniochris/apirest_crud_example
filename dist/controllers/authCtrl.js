...
exports.SignupUser = exports.Authentic = void 0;
  ...
  var _ref = _asyncToGenerator(function* (req, res, next) {
    ...
    try {
      ...
      if (haveUser) {
        ...
        var newUser = yield (0, _User.createUser)(_objectSpread({}, req.body));
...
var Authentic = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(function* (req, res, next) {
    ...
    try {
      ...
      var token = yield (0, _User.verifyUpdateToken)(_objectSpread(_objectSpread({}, req.body), {}, {
        accountVerifyToken
      }));
