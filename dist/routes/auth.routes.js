...
router.post("/signup", _ValidationInputs.validationCreateUser, _authCtrl.SignupUser); // route api/user/

router.post("/signing", _ValidationInputs.validationLogin, _authCtrl.Authentic);
var _default = router;
